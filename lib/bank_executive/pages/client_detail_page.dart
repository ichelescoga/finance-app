...
class _ClientDetailPageState extends State<ClientDetailPage> {
  ...
  void initState() {
    ...
    unitDetailPageController.unitStatus.text = '******** Ramirez';
    unitDetailPageController.quoteHistory.text = '********';
    unitDetailPageController.bankHistory.text = '********';
  }
