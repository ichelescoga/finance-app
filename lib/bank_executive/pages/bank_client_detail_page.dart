...
import 'package:developer_company/quotes/controllers/unit_detail_page_controller.dart';
...
class BankClientDetailPage extends StatefulWidget {
  const BankClientDetailPage({Key? key}) : super(key: key);

  @override
  State<BankClientDetailPage> createState() => _BankClientDetailPageState();
}

class _BankClientDetailPageState extends State<BankClientDetailPage> {
